      ...
      <div id="home-content-inner" class="text-center">
        ...
        <div id="home-text">
          <p>Lorem ipsum dolor sit amet, consectetur
            adipisicing elit. Nam in nihil minima unde qui nihil minima.</p>
        </div>
          ...
          <div class="row wow fadeInUp">
            <div class="col-md-6 col-sm-6">
              ...
              <div class="skill">
                <h4>Web Design</h4>
                <div class="progress">
                  <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"><span>85%</span></div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
              ...
              <div class="skill">
                ...
                <div class="progress">
                  <div class="progress-bar" role="progressbar" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"><span>78%</span></div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
              ...
              <div class="skill">
                ...
                <div class="progress">
                  <div class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"><span>95%</span></div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6">
              ...
              <div class="skill">
                ...
                <div class="progress">
                  <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"><span>90%</span></div>
                </div>
              </div>
            </div>
        ...
        <div id="services-tabs">
          ...
          <div id="service-tab-2" class="service-tab">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <img src="./img/services/service-tab-img-02.jpg" alt="Creativity">
                </div>
                <div class="col-md-6">
                  <div class="tab-bg">
                    <h2>02</h2>
          ...
          <div id="service-tab-3" class="service-tab">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <img src="./img/services/service-tab-img-03.jpg" alt="strategy">
                </div>
                <div class="col-md-6">
                  <div class="tab-bg">
                    <h2>03</h2>
        ...
        <div class="container-fluid">
          <div class="row no-gutters">
            <div id="isotope-container">
              ...
              <!-- Portfolio Item 03 -->
              <div class="col-md-3 col-sm-6 col-xs-12  web logo mobile">
            ...
            <div class="row wow fadeInUp" data-wow-duration="3s">
              <div class="col-md-6 col-sm-6">
                ...
                <div class="blog-post">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                  <a href="https://eatour.herokuapp.com/">Read More </a>
                  <div class="post-meta">
                    <div class="row">
              ...
              <div class="col-md-6 col-sm-6">
                ...
                <div class="blog-post">
                  ...
                  <div class="post-meta">
                    <div class="row">
                      <div class="col-md-6 col-sm-8 col-xs-5">
                        <p><img src="./img/blog/user-2.jpg" alt="author" class="img-circle">Jhoan Petter</p>
                      </div>
                      <div class="col-md-6 col-sm-8 col-xs-7">
                        <p class="text-right">Nov 15,2019</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-6">
            ...
            <div id="contact-right">
              <form>
                ...
                <div class="form-group">
                  <textarea class="form-control" placeholder="Your message will go here" rows="8" cols="80"></textarea>
                </div>
                <div id="submit-btn">
  ...
  <footer class="text-center">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p>
            Copyright &copy; 2019 All Rights Reserverd By <span>SOLO Inc.</span>
          </p>
        </div>
      </div>
    </div>
